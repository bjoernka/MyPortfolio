...
class HelpFunctions: NSObject {
    ...
    static func styleTextField(_ textfield:UITextField) {
        ...
        let borderLine = UIView(frame: CGRect(x: 0, y: textfield.frame.height - 2, width: textfield.frame.width, height: 2))
        borderLine.backgroundColor = UIColor.init(red: 48/255, green: 173/255, blue: 99/255, alpha: 1)
